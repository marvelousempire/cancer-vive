# Harvest Bay — 1 cm breast window

Status: seed. Not a clinic note. Not a protocol. Not advice to have or skip surgery.
Window: results about five days before Sunday 13 Sep 2026; surgery the following week; radiation mentioned after.

## De-identified profile (operator-filed data points)
...
| Next step named | surgery, then radiation |
| Past labs | low iron; low magnesium |
| Lifestyle marks | daily vape; heavy red wine |
...
| A Watch Scale number means the tumor will die | not-supported | C-027 |
| Radiation is chemotherapy | not-supported | Different objects (C-032) |

## Heat map — detriment first

Stay-away this week: delay surgery for an ungraded remedy; concentrated clove oil; undisclosed vape / wine / oils at anesthesia; identity slogan used as care.
